...
\texttt{glob\_wildcard} that will help us to remove the manual listing
of values that we have above.

\section{\texorpdfstring{The \texttt{glob\_wildcard}
Function}{The glob\_wildcard Function}}\label{the-glob_wildcard-function}
