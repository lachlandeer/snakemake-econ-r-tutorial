...
The backbone of our tutorial is a dataset and a set of `R` scripts that need to be executed 
  ...
  some scripts need to be run multiple times across different configurations.
To work through the tutorial and run the commands yourself, you will need to download these files.
You can either:  
